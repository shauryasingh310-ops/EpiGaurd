    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
              ...
              {t("healthcare.availableBeds")}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-primary">{totalBeds}</p>
            <p className="text-xs text-muted-foreground mt-1">{t("healthcare.acrossHospitals")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
              ...
              {t("healthcare.avgResponseTime")}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-primary">{avgResponseTime}h</p>
            <p className="text-xs text-muted-foreground mt-1">{t("healthcare.toOutbreakLocation")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
              <Truck className="w-4 h-4" />
              {t("healthcare.resourcesDispatched")}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-primary">{resourceAllocations.length}</p>
            <p className="text-xs text-muted-foreground mt-1">{t("healthcare.activeAllocations")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card border-border">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2">
              ...
              {t("healthcare.interventionsThisWeek")}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-primary">56</p>
            <p className="text-xs text-muted-foreground mt-1">{t("healthcare.communityInterventions")}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="hospitals" className="space-y-4">
        <TabsList className="bg-card border border-border">
          <TabsTrigger value="hospitals">{t("healthcare.hospitalCapacity")}</TabsTrigger>
          <TabsTrigger value="resources">{t("healthcare.resourceAllocation")}</TabsTrigger>
          <TabsTrigger value="contacts">{t("healthcare.emergencyContacts")}</TabsTrigger>
          <TabsTrigger value="performance">{t("healthcare.performanceMetrics")}</TabsTrigger>
        </TabsList>
