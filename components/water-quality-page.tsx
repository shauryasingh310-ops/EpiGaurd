                  ...
                  <div key={source.id} className="p-4 bg-background rounded-lg border border-border">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3 text-sm">
                      <div className="bg-card p-2 rounded border border-border">
                        <p className="text-muted-foreground text-xs">{t("waterQuality.phLevel")}</p>
                        <p className="font-semibold">{source.ph_level}</p>
                        <p className="text-xs text-muted-foreground">
                          {source.ph_level < 6.5 || source.ph_level > 8.5 ? t("waterQuality.abnormal") : t("waterQuality.normal")}
                        </p>
                      </div>
                      <div className="bg-card p-2 rounded border border-border">
                        <p className="text-muted-foreground text-xs">{t("waterQuality.bacterialCount")}</p>
